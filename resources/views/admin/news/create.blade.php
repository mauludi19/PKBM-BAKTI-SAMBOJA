            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <a href="{{ route('admin.news.index') }}" class="block w-full bg-gray-200 hover:bg-gray-300 text-gray-900 px-4 py-2 rounded-lg font-semibold transition text-center">
                            Batal
                        </a>
                    </div>
                </div>
