    ...
    <footer class="border-t border-gray-800 bg-gray-900 text-gray-200">
        <div class="mx-auto grid max-w-7xl gap-8 px-6 py-10 sm:px-10 md:grid-cols-3">
            <div>
                ...
                <p class="mt-3 text-sm leading-6 text-gray-400">Lembaga pendidikan non-formal untuk program kesetaraan Paket A, B, dan C.</p>
            </div>
            <div>
            ...
            <div>
                ...
                <p class="mt-3 text-sm leading-6 text-gray-400">info@pkbmbakti.ac.id<br>(0274) 555-0999<br>Korong Kayu Samuk, Kab. Solok</p>
            </div>
        </div>
    </footer>
</body>
